 ...
 * 
 * TODO {@link #equals(Object)} fails on oracle because the hql has a 1 that is subtracted after the 
 *  subquery rather than before. Changing to -1 + ____.size works
 * 
 */
public class RemoveGroupFollowers extends BaseArgDomainMapper<Long, List<Long>>
{
    ...
    public List<Long> execute(final Long inRequest)
    {
        ...
        getEntityManager().createQuery(// \n
                "UPDATE VERSIONED Person SET groupsCount = -1 + followingGroup.size WHERE id IN "// \n
