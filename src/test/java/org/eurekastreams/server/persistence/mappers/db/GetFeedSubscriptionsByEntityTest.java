...
import org.eurekastreams.testing.DomainEntityIdComparator;
import org.junit.Test;
import org.springframework.beans.factory.annotation.Autowired;

/**
 * Tests the get feed subs by entity.
 * TODO needed to add the DomainEntityIdComparator to get this test to pass,
 * since oracle doesn't necessarily return ids in numerical order
 */
public class GetFeedSubscriptionsByEntityTest  extends MapperTest
{
    ...
    public void execute()
    {
        ...
        Collections.sort(feedSubs, new DomainEntityIdComparator());
