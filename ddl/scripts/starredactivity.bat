@echo off
echo.
echo Importing table starredactivity to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @starredactivity_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=starredactivity.ctl log=starredactivity.log rows=1000 readsize=83000 bindsize=83000
