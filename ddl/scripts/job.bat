@echo off
echo.
echo Importing table job to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @job_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=job.ctl log=job.log rows=1000 readsize=880000 bindsize=880000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @job_id.sql
