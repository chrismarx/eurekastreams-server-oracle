...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @background_honors_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=background_honors.ctl log=background_honors.log rows=1000 readsize=106000 bindsize=106000
