...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @plugindefinition_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=plugindefinition.ctl log=plugindefinition.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @plugindefinition_id.sql
