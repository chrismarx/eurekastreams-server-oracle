@echo off
echo.
echo Importing table background_skills to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @background_skills_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=background_skills.ctl log=background_skills.log rows=1000 readsize=106000 bindsize=106000
