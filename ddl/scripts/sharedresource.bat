@echo off
echo.
echo Importing table sharedresource to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @sharedresource_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=sharedresource.ctl log=sharedresource.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @sharedresource_id.sql
