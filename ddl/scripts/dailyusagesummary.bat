...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @dailyusagesummary_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=dailyusagesummary.ctl log=dailyusagesummary.log rows=1000 readsize=353000 bindsize=353000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @dailyusagesummary_id.sql
