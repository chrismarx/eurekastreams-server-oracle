...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @person_likedsharedresources_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=person_likedsharedresources.ctl log=person_likedsharedresources.log rows=1000 readsize=83000 bindsize=83000
