@echo off
echo.
echo Importing table image to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @image_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=image.ctl log=image.log rows=1000 readsize=595000 bindsize=595000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @image_id.sql
