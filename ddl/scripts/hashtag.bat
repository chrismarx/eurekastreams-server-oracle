@echo off
echo.
echo Importing table hashtag to Oracle
rem Generated by (c) Ispirer SQLWays 4.0 Build 374 EVALUATION VERSION
rem Timestamp: Sun May 01 19:40:34 2011
...
rem 	hashtag.bat table

rem To import data into the table run:
rem 	hashtag.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @hashtag_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=hashtag.ctl log=hashtag.log rows=1000 readsize=594000 bindsize=594000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @hashtag_id.sql
