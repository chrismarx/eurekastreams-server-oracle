@echo off
echo.
echo Importing table oauthconsumer to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @oauthconsumer_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=oauthconsumer.ctl log=oauthconsumer.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @oauthconsumer_id.sql
