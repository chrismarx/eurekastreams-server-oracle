@echo off
echo.
echo Importing table appdata to Oracle
...
rem 	appdata.bat table

rem To import data into the table run:
rem 	appdata.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @appdata_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=appdata.ctl log=appdata.log rows=1000 readsize=165000 bindsize=165000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @appdata_id.sql
