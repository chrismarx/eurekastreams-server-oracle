@echo off
echo.
echo Importing table "comment" to Oracle
rem Generated by (c) Ispirer SQLWays 4.0 Build 374 EVALUATION VERSION
rem Timestamp: Sun May 01 19:40:21 2011
...
rem 	comment.bat table

rem To import data into the table run:
rem 	comment.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @comment_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=comment.ctl log=comment.log rows=1000 readsize=705000 bindsize=705000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @comment_id.sql
