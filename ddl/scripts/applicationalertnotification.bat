@echo off
echo.
echo Importing table applicationalertnotification to Oracle
...
rem 	applicationalertnotification.bat all

rem To create table and its constraints run:
rem 	applicationalertnotification.bat table

rem To import data into the table run:
rem 	applicationalertnotification.bat import

rem To create indexes for the table run:
rem 	applicationalertnotification.bat idx

rem To execute all DDL statements for the table run:
rem 	applicationalertnotification.bat ddl
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @applicationalertnotification_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=applicationalertnotification.ctl log=applicationalertnotification.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @applicationalertnotification_id.sql
