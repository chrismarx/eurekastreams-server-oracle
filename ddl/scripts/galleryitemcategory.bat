...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @galleryitemcategory_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=galleryitemcategory.ctl log=galleryitemcategory.log rows=1000 readsize=695000 bindsize=695000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @galleryitemcategory_id.sql
