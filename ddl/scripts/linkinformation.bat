@echo off
echo.
echo Importing table linkinformation to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @linkinformation_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=linkinformation.ctl log=linkinformation.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @linkinformation_id.sql
