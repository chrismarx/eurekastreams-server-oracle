@echo off
echo.
echo Importing table tab to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @tab_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=tab.ctl log=tab.log rows=1000 readsize=230000 bindsize=230000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @tab_id.sql
