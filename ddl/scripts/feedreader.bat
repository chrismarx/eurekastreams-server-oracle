...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @feedreader_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=feedreader.ctl log=feedreader.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @feedreader_id.sql
