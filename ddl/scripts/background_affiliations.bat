@echo off
echo.
echo Importing table background_affiliations to Oracle
...
rem 	background_affiliations.bat all

rem To create table and its constraints run:
rem 	background_affiliations.bat table

rem To import data into the table run:
rem 	background_affiliations.bat import

rem To create indexes for the table run:
rem 	background_affiliations.bat idx

rem To execute all DDL statements for the table run:
rem 	background_affiliations.bat ddl
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @background_affiliations_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=background_affiliations.ctl log=background_affiliations.log rows=1000 readsize=106000 bindsize=106000
