@echo off
echo.
echo Importing table organization_coordinators to Oracle
...
rem 	organization_coordinators.bat all

rem To create table and its constraints run:
rem 	organization_coordinators.bat table

rem To import data into the table run:
rem 	organization_coordinators.bat import

rem To create indexes for the table run:
rem 	organization_coordinators.bat idx

rem To execute all DDL statements for the table run:
rem 	organization_coordinators.bat ddl
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @organization_coordinators_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=organization_coordinators.ctl log=organization_coordinators.log rows=1000 readsize=83000 bindsize=83000
