@echo off
echo.
echo Importing table stream to Oracle
rem Generated by (c) Ispirer SQLWays 4.0 Build 374 EVALUATION VERSION
rem Timestamp: Sun May 01 19:40:45 2011
...
rem 	stream.bat table

rem To import data into the table run:
rem 	stream.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @stream_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=stream.ctl log=stream.log rows=1000 readsize=644000 bindsize=644000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @stream_id.sql
