...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @appdatavalue_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=appdatavalue.ctl log=appdatavalue.log rows=1000 readsize=636000 bindsize=636000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @appdatavalue_id.sql
