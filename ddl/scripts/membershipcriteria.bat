...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @membershipcriteria_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=membershipcriteria.ctl log=membershipcriteria.log rows=1000 readsize=635000 bindsize=635000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @membershipcriteria_id.sql
