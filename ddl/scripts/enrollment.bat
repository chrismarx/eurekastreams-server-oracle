@echo off
echo.
echo Importing table enrollment to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @enrollment_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=enrollment.ctl log=enrollment.log rows=1000 readsize=740000 bindsize=740000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @enrollment_id.sql
