...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @feedsubscriber_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=feedsubscriber.ctl log=feedsubscriber.log rows=1000 readsize=718000 bindsize=718000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @feedsubscriber_id.sql
