@echo off
echo.
echo Importing table tabgroup to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @tabgroup_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=tabgroup.ctl log=tabgroup.log rows=1000 readsize=83000 bindsize=83000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @tabgroup_id.sql
