...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @group_coordinators_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=group_coordinators.ctl log=group_coordinators.log rows=1000 readsize=83000 bindsize=83000
