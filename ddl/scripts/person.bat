@echo off
echo.
echo Importing table person to Oracle
rem Generated by (c) Ispirer SQLWays 4.0 Build 374 EVALUATION VERSION
rem Timestamp: Sun May 01 19:40:12 2011
...
rem 	person.bat table

rem To import data into the table run:
rem 	person.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @person_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=person.ctl log=person.log rows=1000 readsize=1048576 bindsize=1048576



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @person_id.sql
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @person_cns.sql
