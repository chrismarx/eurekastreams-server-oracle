@echo off
echo.
echo Importing table group_capability to Oracle
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @group_capability_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=group_capability.ctl log=group_capability.log rows=1000 readsize=83000 bindsize=83000
