...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @enrollment_activities_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=enrollment_activities.ctl log=enrollment_activities.log rows=1000 readsize=106000 bindsize=106000
