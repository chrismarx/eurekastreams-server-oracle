@echo off
echo.
echo Importing table person_relatedorganization to Oracle
...
rem 	person_relatedorganization.bat all

rem To create table and its constraints run:
rem 	person_relatedorganization.bat table

rem To import data into the table run:
rem 	person_relatedorganization.bat import

rem To create indexes for the table run:
rem 	person_relatedorganization.bat idx

rem To execute all DDL statements for the table run:
rem 	person_relatedorganization.bat ddl
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @person_relatedorganization_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=person_relatedorganization.ctl log=person_relatedorganization.log rows=1000 readsize=83000 bindsize=83000
