...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @enrollment_areasofstudy_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=enrollment_areasofstudy.ctl log=enrollment_areasofstudy.log rows=1000 readsize=106000 bindsize=106000
