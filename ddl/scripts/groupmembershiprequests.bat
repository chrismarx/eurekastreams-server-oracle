@echo off
echo.
echo Importing table groupmembershiprequests to Oracle
...
rem 	groupmembershiprequests.bat all

rem To create table and its constraints run:
rem 	groupmembershiprequests.bat table

rem To import data into the table run:
rem 	groupmembershiprequests.bat import

rem To create indexes for the table run:
rem 	groupmembershiprequests.bat idx

rem To execute all DDL statements for the table run:
rem 	groupmembershiprequests.bat ddl
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @groupmembershiprequests_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=groupmembershiprequests.ctl log=groupmembershiprequests.log rows=1000 readsize=83000 bindsize=83000
