...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @streamitemid_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=streamitemid.ctl log=streamitemid.log rows=1000 readsize=83000 bindsize=83000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @streamitemid_id.sql
