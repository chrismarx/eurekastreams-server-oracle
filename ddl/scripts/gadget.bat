@echo off
echo.
echo Importing table gadget to Oracle
rem Generated by (c) Ispirer SQLWays 4.0 Build 374 EVALUATION VERSION
rem Timestamp: Sun May 01 19:40:31 2011
...
rem 	gadget.bat table

rem To import data into the table run:
rem 	gadget.bat import
...
sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @gadget_ddl.sql
...
sqlldr userid=eureka_streams/YourekaTent!@SW2_GUILLEMOT control=gadget.ctl log=gadget.log rows=1000 readsize=301000 bindsize=301000



echo Creating a sequence and trigger to implement the identity column

sqlplus eureka_streams/YourekaTent!@SW2_GUILLEMOT @gadget_id.sql
